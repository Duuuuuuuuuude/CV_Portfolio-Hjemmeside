...
public static class TemporaryRepositoryClass
{
    public static SortedList<int, OnlinePresenceDTO> GetSearchResultModels() => new SortedList<int, OnlinePresenceDTO>()
        {
            {0, new OnlinePresenceDTO()
            {
                ...
                SearchResult = new SearchResultDTO(Guid: new Guid(),
                                                   SiteImageRelativePath_32_32: "/images/LinkedIn_Logo_32x32.png",
                ...
                SiteName = "LinkedIn",
                Image_56x56 = "/images/LinkedIn_Logo_56x56.png",
            ...
            {1, new OnlinePresenceDTO()
            {
                Guid = new Guid(),
                SearchResult = new SearchResultDTO(Guid: new Guid(),
                                                      SiteImageRelativePath_32_32: "/images/GitHub_Logo_32x32.png",
            ...
            {2, new OnlinePresenceDTO()
            {
                ...
                SiteName = "GitHub",
                Image_56x56 = "/images/GitHub_Logo_56x56.png",
    ...
    public static SearchQueryParametersDTO GetSearchParameters() =>
        new(Guid: new Guid(),
            ...
            QueryStringPortfolio: "Martin Koldste's Projekter site:https://github.com/");
